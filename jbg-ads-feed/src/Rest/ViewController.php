...
class ViewTrackController {
    ...
    public static function track(\WP_REST_Request $req) {
        ...
        // اطمینان از وجود جدول jbg_views (مستقل از بیلینگ)
        self::ensure_table();

        global $wpdb;
        $table = $wpdb->prefix.'jbg_views';

        // اگر در ۲۴ ساعت گذشته بازدیدی از این کاربر برای این آگهی داشته‌ایم، دوباره ثبت نکن
        ...
        // افزایش اتمی شمارنده‌ی بازدید فقط روی کلید واحد
