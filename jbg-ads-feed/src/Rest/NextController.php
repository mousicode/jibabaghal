...
class NextController {
    ...
    public static function handle(\WP_REST_Request $req) {
        ...
        // فقط «قبولی آزمون» ملاک آزاد شدن ویدیو بعدی است
        $quiz_ok = (bool) get_user_meta($uid, 'jbg_quiz_passed_'.$current, true);
        if (!$quiz_ok) {
            return new \WP_REST_Response(['ok'=>false,'reason'=>'quiz_required'], 403);
        }
