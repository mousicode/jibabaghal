...
class VideoMetaBox {
    ...
    public static function render(\WP_Post $post): void {
        ...
        ?>
        <p><label><?php echo esc_html__('Direct video URL (mp4/webm/…)', 'jbg-ads'); ?></label><br>
           <input type="url" name="jbg_video_url" value="<?php echo esc_attr((string)$url); ?>" style="width:100%" placeholder="https://.../video.mp4">
        </p>
        <p><label><?php echo esc_html__('Embed HTML (optional – e.g. Aparat/YouTube iframe)', 'jbg-ads'); ?></label><br>
        ...
        <p style="color:#555">
           <?php echo esc_html__('Player will prefer Embed HTML if provided; otherwise uses Direct URL (oEmbed or wp_video).', 'jbg-ads'); ?>
        </p>
        <?php
    }
