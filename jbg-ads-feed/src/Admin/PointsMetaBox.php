...
class PointsMetaBox {
    ...
    public static function render(\WP_Post $post): void {
        ...
        ?>
        <p style="margin:0 0 8px"><?php _e('این امتیاز بعد از پاس‌شدن آزمون این ویدیو به کاربر تعلق می‌گیرد.', 'jbg-ads');?></p>
        <label for="jbg_points"><?php _e('امتیاز', 'jbg-ads'); ?></label>
    ...
    public static function save(int $post_id, \WP_Post $post): void {
        if (!isset($_POST['jbg_ad_points_nonce']) || !wp_verify_nonce($_POST['jbg_ad_points_nonce'], 'jbg_ad_points_nonce')) return;
