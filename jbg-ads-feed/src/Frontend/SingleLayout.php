...
class SingleLayout {
    ...
    public static function wrap($content) {
        ...
        // استایل‌ها: کانتینر 1312px + اوورراید المنتور + فول-بليد برای خود پلیر درون .page-content
        $style = '<style id="jbg-single-stack-css">
          ...
          /* ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
             مهم‌ترین بخش: پلیر را از محدودیت 800px خارج و دقیقاً هم‌عرض هدر/فوتر کن
             این سِلکتور فقط وقتی پلیر مستقیماً زیر .page-content چاپ شده باشد اعمال می‌شود.
          ـــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ */
