...
class SingleLayout {
    ...
    public static function wrap($content) {
        ...
        if ($is_open) {
            ...
            // ← نشان امتیاز را بعد از عنوان تزریق کن (در صورت وجود امتیاز)
            if ($points > 0) {
                ...
                $html .= $badge;
                $html .= '<script>(function(){try{var b=document.getElementById("jbg-points-badge");if(!b)return;
