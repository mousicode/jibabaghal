...
class ListShortcode {
    ...
    public static function render($atts = []): string {
        ...
        // قفل‌گذاری: ویدیو 0 باز؛ n+1 منوط به پاس n
        ...
        foreach ($rows as $idx => $it) {
            ...
            $out .= '    <h4 style="margin:0 0 6px 0;font-weight:700">'.$title.'</h4>';
            $out .= '    <div class="jbg-card__meta" style="font-size:12px;color:#6b7280">'
                 .        'بازدید '.(int) get_post_meta($it['ID'],'jbg_views_count',true).' • '.$age
                 .      '</div>';
