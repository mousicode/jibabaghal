...
class SponsorRegister {
    ...
    private static function render_plans_ui(string $token): string {
        ...
        $plans = [
            'free'   => ['title' => 'پلن رایگان',   'desc' => 'شروع همکاری با حداقل امکانات، مناسب تست و آشنایی اولیه.'],
            'eco'    => ['title' => 'پلن اقتصادی',  'desc' => 'تعرفه متعادل برای کسب‌وکارهای کوچک و متوسط.'],
            'corp'   => ['title' => 'پلن سازمانی',  'desc' => 'امکانات کامل برای برندها و سازمان‌های بزرگ.'],
        ];
